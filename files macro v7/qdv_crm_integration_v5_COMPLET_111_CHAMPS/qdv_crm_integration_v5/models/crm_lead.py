...
class CrmLead(models.Model):
    ...
    qdv_currencyisocode = fields.Char(string="Monnaie du devis", readonly=True, help="Rempli par QuickDevis")
    ...
    # ===== CHAMPS QUICKDEVIS UNIQUEMENT (1 champ) =====

    qdv_id = fields.Char(string="Numéro d\'opportunité", readonly=True, help="Rempli par QuickDevis")

    # ===== CHAMPS BIDIRECTIONNELS (2 champs) =====

    qdv_workstartdate = fields.Date(string="Date de début")
    qdv_workenddate = fields.Date(string="Date de fin")
        ...
        try:
            ...
            return {
                ...
                'params': {
                    ...
                    'message': f'L\'opportunité "{self.name}" a été synchronisée vers QuickDevis.\n{len(data_to_send)} champs envoyés.',
                    'type': 'success',
                    'sticky': False,
                }
            }
            ...
            raise UserError(f"Erreur lors de la synchronisation : {str(e)}")
        ...
        try:
            ...
            return {
                ...
                'params': {
                    ...
                    'message': f'Les données de chiffrage de l\'opportunité "{self.name}" ont été récupérées depuis QuickDevis.',
                    'type': 'info',
                    'sticky': False,
                }
            }
            ...
            raise UserError(f"Erreur lors de la récupération : {str(e)}")
